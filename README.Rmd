...
[![R build status](https://github.com/tjtnew/occupancy/workflows/R-CMD-check/badge.svg)](https://github.com/tjtnew/occupancy/actions)
[![CRAN status](https://www.r-pkg.org/badges/version/occupancy)](https://CRAN.R-project.org/package=occupancy)
[![Codecov test coverage](https://codecov.io/gh/tjtnew/occupancy/branch/master/graph/badge.svg)](https://codecov.io/gh/tjtnew/occupancy?branch=master)
<!-- badges: end -->
...
## Functionality
For an introduction to the packages' functionality see view the `Introduction`
vignette.
